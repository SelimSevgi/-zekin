...
// banners datasi için
import Banners from "../api/tempo.json";
  ...
  return (
    <div className="container mx-auto py-4  ">
      <div className="flex flex-col items-center justify-center text-center">
        <img src="https://i.hizliresim.com/efpmh8i.JPG" className="w-[200px]"/>
      <Title>TEMPOCAM ÜRÜN GRUPLARI</Title>
      <BsChevronDoubleDown size={20} className="mb-9 bg-red-600w-36 " /></div>
